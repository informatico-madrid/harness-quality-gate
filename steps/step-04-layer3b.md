...
```bash
python3 ${CLAUDE_SKILL_DIR}/scripts/llm_solid_judge.py {project-root}/src/ 2>&1
```
...
```bash
python3 ${CLAUDE_SKILL_DIR}/scripts/antipattern_judge.py {project-root}/src/ {project-root}/tests/ 2>&1
```
