...
```bash
python3 ${CLAUDE_SKILL_DIR}/BMAD Tier B (deferred) {project-root}/src/ 2>&1
```
...
```bash
python3 ${CLAUDE_SKILL_DIR}/BMAD Tier B (deferred) {project-root}/src/ {project-root}/tests/ 2>&1
```
