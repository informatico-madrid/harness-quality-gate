...
def run_principles(src_dir: str) -> dict[str, Any]:
    """Run all principle checks on a source directory.

    Returns a dict with keys DRY, KISS, YAGNI, LoD, CoI, each containing
    status, violations count, and details.
    """
