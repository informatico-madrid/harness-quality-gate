...
class RuffAdapter(ToolAdapter):
    ...
    def invoke(
        ...
        *,
        ...
        if args:
            cmd.extend(args)
        # src/tests only: the whole repo would include mutation artifacts
        # generated by L1's own campaign (mutants/) — simulation bug H10.
        cmd.extend(source_targets(repo, "src", "tests") or ["."])
